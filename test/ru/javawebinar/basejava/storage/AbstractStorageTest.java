...
public abstract class AbstractStorageTest {
    ...
    private final String UUID_1 = "uuid9";
    private Resume RESUME_1 = new Resume(UUID_1, "Петров Александр Владимирович");
    private final String UUID_2 = "uuid2";
    private Resume RESUME_2 = new Resume(UUID_2, "Антонов Игорь Станиславович");
    private final String UUID_3 = "uuid3";
    private Resume RESUME_3 = new Resume(UUID_3,"Петров Александр Владимирович");
    private final String UUID_4 = "uuid4";
    private Resume RESUME_4 = new Resume(UUID_4, "Александров Сергей Викторович");
    ...
    public void getAll() {
        ...
        Resume[] actualArray = storage.getAllSorted();
